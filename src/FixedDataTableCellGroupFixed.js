 ...
 */
 ...
 class FixedDataTableCellGroupFixedImpl extends React.Component {
   /**
 ...
 class FixedDataTableCellGroupFixed extends React.Component {
   /**
    * PropTypes are disabled in this component, because having them on slows
    * down the FixedDataTable hugely in DEV mode. You can enable them back for
    * development, but please don't commit this component with enabled propTypes.
   ...
   render() /*object*/ {
     ...
     return (
       ...
       >
         <FixedDataTableCellGroupFixedImpl {...props} />
       </div>
     );
   }
 }
 export default FixedDataTableCellGroupFixed;
